---
description: Live Blog consente di visualizzare aggiornamenti e immagini in tempo reale dagli editor del sito durante la copertura di un evento live.
title: Blog dal vivo
...
Live Blog consente di visualizzare aggiornamenti e immagini in tempo reale dagli editor del sito durante la copertura di un evento live.
...
Per incorporare un’app di blog in tempo reale, segui la procedura per incorporare un’app . Consulta [Incorporare un&#39;app](/help/implementation/c-livefyre-identity-comp/t-using-studio-to-connect-your-social-apps-to-your-livefyre-implementation.md). Di seguito è riportato un esempio dell&#39;aspetto di un&#39;app di blog in tempo reale incorporata.
...
CollectionMeta è un oggetto JSON codificato. Nell’esempio precedente, l’oggetto JSON assume il formato seguente prima della codifica JWT:
...
| **rete** | ** requiredstring Un nome di rete fornito da Livefyre. Ad esempio: *nome.file.co.* |
| **attachmentDelegate** | ** optionalobject | Utilizzato per specificare i tipi di allegati multimediali visibili nel flusso di app. Per ulteriori informazioni, consulta [Limitazione di Media](../c-app-customizations/c-restrict-media.md#c_restrict_media). |
...
| **collectionMeta** | ** requiredstring | Metadati codificati JWT sulla raccolta. Per ulteriori informazioni, consulta Oggetto CollectionMeta . |
...
| **anonymousFlaggingEnabled** | booleano | Definisce se gli utenti ospiti possono contrassegnare il contenuto. Il valore predefinito è true. |
...
| **checksum** | ** optionalstring (consigliato) | Identifica lo stato corrente di CollectionMeta. La modifica di questo valore comporterà l’aggiornamento dei dati sul server da parte di Livefyre con i nuovi valori in CollectionMeta. |
...
| **editorCss** | ** optionalobject | Utilizzato per personalizzare lo stile dell’editor dei commenti. È possibile formattare il colore di sfondo del campo dell’editor, nonché il colore del font, le dimensioni e la famiglia del testo visualizzato all’interno dell’editor.  Ad esempio: {background: ‘#ccc’, colore: &quot;rosso&quot;, font: ’30px &quot;Helvetica Neue&quot;, Helvetica, Arial, Ginevra, sans-serif&quot;} |
