...
Quindi, posizionate l’elemento in cui apparirà Media Wall.
...
Ora hai un muro! Vedere tutto in azione in [questo esempio](https://codepen.io/gobengo/pen/dFwDL).
...
>[!NOTE]
>
>Qualsiasi personalizzazione stile dei tweet renderizzati dall&#39;app Media Wall deve essere eseguita in conformità ai [requisiti di visualizzazione di Twitter](https://dev.twitter.com/terms/display-requirements).
...
Definisce il pulsante [!UICONTROL Post Content] da visualizzare sulla parete. Questa opzione richiede il passaggio di `opts.collection` e l&#39;aggiunta di un&#39;integrazione Livefyre.js Auth alla pagina.
...
Definisce il numero di elementi di contenuto da aggiungere alla bacheca quando si fa clic sul pulsante [!UICONTROL Show More].
...
Per un input valido, vedere gli standard W3C per le proprietà CSS [Famiglia di font](https://www.w3.org/TR/CSS2/fonts.html#propdef-font-family), [Dimensione font](https://www.w3.org/TR/CSS2/fonts.html#font-size-props), [Altezza linea,](https://www.w3.org/TR/CSS2/visudet.html#propdef-line-height) e [Colore](https://www.w3.org/TR/css3-color/#colorunits).
...
* **linkAttachmentBackgroundColor** *(CSS Color String)* Il colore di sfondo per gli allegati di collegamento (allegati sovrapposti).
...
* **usernameColor** *(CSS Color String)* Il colore per i nomi utente nel nome utente.
